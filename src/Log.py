...
def usage():
    print("Utilisation : ")
    print("python SoaIntegrationTests.py -e <environnement> -t <test> -l <loglevel>")
    print("")
    print("Options : ")
    ...
    print("-l <loglevel> (--loglevel) OPTIONNEL : Niveau de log à appliquer à l'exécution du programme (DEBUG, INFO, WARN ou ERROR)")
    print("---")
    print("  Environnements possibles : DEV, INT, VAL")
    print("  Exemples de tests a rechecher : PostGreToDB2, DB2ToPostGre, PostGreToPostGre, ...")
    print("  Exemples: python SoaIntegrationTests.py -e INT -t PostGreToDB2")
    print("            python SoaIntegrationTests.py -e VAL")
    print("            python SoaIntegrationTests.py -e DEV -l DEBUG")
    print("---")